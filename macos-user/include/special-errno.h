...
/*
 * QEMU internal errno values for implementing macOS user-mode emulation.
 *
 *  Copyright (c) 2024 QEMU Project
 */
 ...
 * or guest errno.
 *
 * macOS errno values range from 1-106 (as of macOS 14).
 * We use values starting at 512 to avoid conflicts.
 */
